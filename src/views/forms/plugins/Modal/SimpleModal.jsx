...
function BodyContent({ modalStyle, handleClose }, ref) {
  return (
...
const Body = forwardRef(BodyContent);
...
BodyContent.propTypes = { modalStyle: PropTypes.any, handleClose: PropTypes.func };
