    ...
    <Card sx={{ mb: 3, boxShadow: shadow }}>
      <Box
        sx={{
          ...
          alignItems: 'center',
          py: 4.5,
          bgcolor: theme.palette.mode === ThemeMode.DARK ? 'grey.500' : 'primary.light',
          color: theme.palette.mode === ThemeMode.DARK ? 'grey.50' : 'grey.800'
        }}
      >
  ...
  return (
    <Card sx={{ mb: 3, boxShadow: shadow }}>
      ...
      >
        ...
        {label && <Box sx={{ color: theme.palette.mode === ThemeMode.DARK ? 'common.white' : 'inherit' }}>{label}</Box>}
      </Box>
    </Card>
  );
}
