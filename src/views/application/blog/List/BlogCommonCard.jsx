...
const blogData = [
  {
    ...
    details:
      'Dive deep into React Hooks and learn how to manage state and side effects effectively. This comprehensive guide covers useState, useEffect, useContext, and custom hooks for building powerful React applications.',
    name: 'John Doe',
    avatar: Avatar1,
    pro: true,
    image: 'blog-1',
...
export default function BlogCommonCard() {
  ...
  const handleShareClick = (event, index) => {
    setShare({ index, element: event.currentTarget });
  };
