...
// chart data
import chartData from '../chart-data/analytics-bar-charts';
...
export default function AnalyticsBarChart({ isLoading }) {
  ...
  }, [mode, primaryMain, primary, divider, isLoading, grey500, dividerDark]);
    ...
    >
      <Stack sx={{ gap: 3 }}>
        ...
        <Box sx={{ '& .apexcharts-legend-text': { pl: themeDirection === ThemeDirection.RTL ? 0 : 1 } }}>
          <Chart {...chartData} series={series} height={downSM ? 300 : 346} />
        </Box>
      </Stack>
      <Menu
