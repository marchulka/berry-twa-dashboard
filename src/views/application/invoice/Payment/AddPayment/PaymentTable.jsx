...
export default function PaymentTable({ formik, row }) {
            ...
            {row.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <Typography component={Link} to="/apps/invoice/invoice-list" variant="h5" sx={{ textDecoration: 'none' }}>
                      #{item.invoice_id}
                    </Typography>
                  </TableCell>
...
PaymentTable.propTypes = { formik: PropTypes.any, row: PropTypes.array };
