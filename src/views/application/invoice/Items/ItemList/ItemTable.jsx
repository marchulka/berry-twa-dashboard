...
export default function ItemTable({ open, setOpen, setRowValue, rows }) {
...
ItemTable.propTypes = { open: PropTypes.bool, setOpen: PropTypes.func, setRowValue: PropTypes.func, rows: PropTypes.array };
