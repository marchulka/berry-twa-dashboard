...
export default function SelectItem({ handleAddItem, setAddItemClicked }) {
  ...
  const handleEditInvoiceItem = (event) => {
...
SelectItem.propTypes = { handleAddItem: PropTypes.func, setAddItemClicked: PropTypes.func };
