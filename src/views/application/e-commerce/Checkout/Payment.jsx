...
export default function Payment({ checkout, onBack, onNext, handleShippingCharge }) {
...
Payment.propTypes = { checkout: PropTypes.any, onBack: PropTypes.func, onNext: PropTypes.func, handleShippingCharge: PropTypes.func };
