...
export default function Cart({ checkout, onNext, removeProduct, updateQuantity }) {
  ...
  return (
    <Grid container spacing={gridSpacing}>
      ...
      <Grid size={12}>
        <Grid container direction={{ xs: 'column-reverse', lg: 'row' }} spacing={3} sx={{ alignItems: { xs: 'flex-start', lg: 'center' } }}>
...
Increment.propTypes = {
  itemId: PropTypes.oneOfType([PropTypes.string, PropTypes.any, PropTypes.number]),
