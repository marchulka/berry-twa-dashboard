...
export default function FollowupTableBody({ labelId, row, selected, handleClick }) {
...
FollowupTableBody.propTypes = { labelId: PropTypes.any, row: PropTypes.any, selected: PropTypes.array, handleClick: PropTypes.func };
