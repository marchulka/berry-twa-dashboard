...
export default function Filter({ rows, setRows, handleToggleAddDialog }) {
...
Filter.propTypes = { rows: PropTypes.array, setRows: PropTypes.func, handleToggleAddDialog: PropTypes.func };
