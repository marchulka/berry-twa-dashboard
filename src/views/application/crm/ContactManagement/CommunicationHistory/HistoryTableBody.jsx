...
export default function HistoryTableBody({ labelId, row, selected, handleClick }) {
...
HistoryTableBody.propTypes = { labelId: PropTypes.string, row: PropTypes.any, selected: PropTypes.array, handleClick: PropTypes.func };
