...
export default function AddLeadDialog({ open, handleToggleAddDialog, row }) {
  return (
    <Dialog
      open={open}
...
AddLeadDialog.propTypes = { open: PropTypes.bool, handleToggleAddDialog: PropTypes.func, row: PropTypes.any };
