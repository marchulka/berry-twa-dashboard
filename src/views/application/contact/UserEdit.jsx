...
export default function UserEdit({ user, onCancel, onSave, ...others }) {
...
UserEdit.propTypes = { user: PropTypes.any, onCancel: PropTypes.func, onSave: PropTypes.func, others: PropTypes.any };
