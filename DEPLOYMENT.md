...
### Архитектура системы
```
[Telegram Bot] <─────────> [TWA Dashboard] <─────────> [PostgreSQL]
      │                          │                          │
      │                          │                          │
      v                          v                          v
BotFather API             Railway Hosting           Railway Database
     │                          │                          │
     └──────────────────────────┴──────────────────────────┘
...
1. **Высший приоритет - База данных (P0)**
   - Восстановление из бэкапа
   - Проверка целостности данных
   - Время восстановления: до 15 минут

2. **Средний приоритет - TWA Dashboard (P1)**
   - Восстановление последней стабильной версии
   - Проверка всех компонентов UI
   - Время восстановления: до 10 минут

3. **Низкий приоритет - Интеграция с ботом (P2)**
   - Проверка WebApp URL
   - Обновление настроек в BotFather
   - Время восстановления: до 5 минут

### Максимальное допустимое время восстановления
- Полное восстановление: 30 минут
- Частичное восстановление: 15 минут
...
curl -I https://berry-twa-dashboard-production.up.railway.app
```

### Контакты для эскалации
1. Railway Support: через Dashboard
2. GitHub Issues: https://github.com/marchulka/berry-twa-dashboard/issues
3. Telegram Support: @BotFather (для проблем с WebApp) 